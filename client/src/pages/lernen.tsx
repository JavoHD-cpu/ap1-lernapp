...
import {
  ...
  Calculator, BookMarked, GraduationCap, ArrowLeft
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border sticky top-0 z-10 bg-background/95 backdrop-blur">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold text-foreground leading-none">Lernen & Quiz</h1>
              <p className="text-xs text-muted-foreground">AP1 Prüfungsvorbereitung</p>
            </div>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 animate-fadeInUp">
          <h2 className="text-2xl font-bold text-foreground mb-1">Lernen & Quiz</h2>
